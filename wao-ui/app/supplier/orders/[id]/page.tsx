...
import { ArrowLeft, Calendar, Package, Save } from 'lucide-react'
...
export default function SupplierOrderDetailPage() {
  ...
  const updateOrderStatus = async () => {
    if (!order || selectedStatus === order.status.toLowerCase()) {
      return
    }

    setIsUpdating(true)
    try {
      const response = await fetch(`${API_BASE_URL}/purchase-order/${params.id}/status`, {
        method: "PATCH",
        headers: {
          Accept: "application/json",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              <Button variant="ghost" onClick={() => router.push("/supplier/orders")} className="mr-4">
            ...
            <CardContent>
              <div className="flex items-center space-x-4">
                ...
                <Button
                  ...
                  disabled={isUpdating || selectedStatus === order.status.toLowerCase()}
                >
